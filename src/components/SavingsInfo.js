  ...
  return (
    ...
    >
      <Box
        ...
        p={['37px 23px', '47px 53px']}
      >
        <Text fontSize="14px" color="#666666" opacity="80%">
          I want to save
        </Text>
        <HStack opacity="80%">
          <Text fontSize={['12px', '14px']} fontWeight="500" color="#33343D">
            NGN{' '}
          </Text>
          <Input
            variant="unstyled"
        ...
        <Text color="#FF4949" fontSize="12px" fontWeight="500">
          {errorMessageForAmount}
        </Text>
        <Stack m={['30px 0', '60px 0']} direction="row">
          ...
          <Button
            ...
            fontSize={['11px', '12px']}
            color="#33343D"
            bg={frequency === 'monthly' ? '#F2C9E3' : '#fff'}
            onClick={() => {
        ...
        <Text color="#666666" fontSize="14px" fontWeight="500" opacity="70%">
          for
        </Text>
        <HStack spacing={0}>
          <Input
        ...
        <Text color="#FF4949" fontSize="12px" fontWeight="500" opacity="80%">
          {errormessage}
        </Text>
      </Box>
    </Box>
